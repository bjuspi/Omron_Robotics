...
def from_controller_state_to_dict(pControllerState):
    ...
    #d['Grip Button Pressed'] = pControllerState.ulButtonPressed
    #d['Grip Button Touched'] = pControllerState.ulButtonTouched
    # To make easier to understand what is going on
    # Second bit marks menu button
    d['Menu Button'] = bool(pControllerState.ulButtonPressed >> 1 & 1)
    # 32 bit marks trackpad
    d['Trackpad Pressed'] = bool(pControllerState.ulButtonPressed >> 32 & 1)
    d['Trackpad Touched'] = bool(pControllerState.ulButtonTouched >> 32 & 1)
    # third bit marks grip button
    d['Grip Button'] = bool(pControllerState.ulButtonPressed >> 2 & 1)
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Control+C pressed, shutting down...")
        openvr.shutdown()
        df = df.drop(columns=["unPacketNum"])
        df.to_csv("htc_vive_controller_button_output.csv")