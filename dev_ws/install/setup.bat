...
call:_colcon_prefix_chain_bat_call_script "C:\dev\ros2_foxy\ros2-windows\local_setup.bat"
call:_colcon_prefix_chain_bat_call_script "C:\dev\ros2_foxy\ros2-windows\\local_setup.bat"
call:_colcon_prefix_chain_bat_call_script "D:\Hiverlab\Omron_Robotics\dev_ws\install\\local_setup.bat"
