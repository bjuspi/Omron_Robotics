...
bool vive_interfaces__msg__hmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vive_interfaces.msg._hmd.Hmd", full_classname_dest, 28) == 0);
  }
  vive_interfaces__msg__Hmd * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Hmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vive_interfaces.msg._hmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Hmd");
